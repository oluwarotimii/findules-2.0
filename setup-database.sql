-- Findules Database Setup Script for XAMPP MySQL
-- Run this in phpMyAdmin or MySQL command line

-- Create database
CREATE DATABASE IF NOT EXISTS findules CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- Create cash_requisitions table
...
-- Create audit_logs table with JSON type for details field
